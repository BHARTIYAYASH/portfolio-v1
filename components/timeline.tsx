...
export const Timeline = () => {
  ...
  const data: Data[] = [
    {
      title: "Rajiv Gandhi Science & Technology Commission (RGSTC)",
      href: "#",
      content: [
        {
          title: "NLP Software Engineer Intern",
          description: `
            Designed and deployed a hybrid NLP pipeline to resolve Scriptio Continua in historical Modi script.
            Fine-tuned a RoBERTa Token Classifier on 1.6 million records to achieve 99.98% segmentation accuracy.
            Engineered a domain-specific dataset from 1,000+ historical pages to extract archaic vocabulary.
            Optimized training cycles on constrained hardware using Gradient Accumulation and Mixed-Precision (FP16).
          `,
    ...
    {
      title: "OpenxAI (BlockseBlock Labs)",
      href: "#",
      content: [
        {
          title: "AI Developer Intern",
          description: `
            Developed AI applications including ContactEase (OCR-based contact extraction) and PocketPulse.
            Contributed UI/UX improvements and modular features to a production-grade open-source accelerator codebase.
          `,
    ...
    {
      title: "SmartBridge | NASSCOM | MeitY",
      href: "#",
      content: [
        {
          title: "AI & ML Trainee (Capstone)",
          description: `
            Built an ML-based Flask application to predict PMSM rotor temperature using real-time operational parameters.
            Trained and evaluated Linear Regression, Random Forest, and SVM models; deployed the best-performing model.
          `,
