    ...
    const fetchPRs = async () => {
      try {
        const searchQuery = filterType === "all"
          ? "author:BHARTIYAYASH type:pr"
          : filterType === "merged"
            ? "author:BHARTIYAYASH type:pr is:merged"
            : filterType === "open"
              ? "author:BHARTIYAYASH type:pr is:open"
              : "author:BHARTIYAYASH type:pr is:closed is:unmerged";
