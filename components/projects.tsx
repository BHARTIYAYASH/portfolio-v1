  ...
  const projects: Project[] = [
    {
      ...
      video: "",
      description: "An agentic AI system that decomposes complex topics into structured argument maps using live web data. Features logical fallacy detection and credibility scoring.",
      tech: ["next", "ts", "python", "gemini", "firebase"],
      github: "https://github.com/BHARTIYAYASH/TRUTH-MAPPER",
      live: "https://arg-cartographer.vercel.app/",
      starsText: "AI Truth Mapping",
    ...
    },
    {
      ...
      video: "",
      description: "A full-stack automation system to digitize NOC workflows with role-based access, digital approvals, and real-time status tracking.",
      tech: ["python", "django", "tailwind", "firebase"],
      github: "https://github.com/BHARTIYAYASH/E-NOC",
      live: "https://e-noc.vercel.app/",
      starsText: "Academic Automation",
    ...
    },
    {
      ...
      video: "",
      description: "Six Sigma DMAIC analytics platform with automated calculation of DPMO, Sigma Levels, and interactive process metric dashboards.",
      tech: ["react", "ts", "node", "supabase", "charts"],
      github: "https://github.com/BHARTIYAYASH/caretime-six-sigma-dash",
      live: "https://github.com/BHARTIYAYASH/caretime-six-sigma-dash",
      starsText: "Six Sigma Analytics",
